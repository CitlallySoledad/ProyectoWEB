...
class ParticipantTeamController extends Controller
{
    ...
    public function join(Request $request)
    {
        ...
        if ($team->joinRequests()->where('user_id', auth()->id())->where('status', 'pending')->exists()) {
            return back()->with('error', 'Ya tienes una solicitud pendiente en este equipo.');
        }
    ...
    public function sendInvitation(Request $request)
    {
        ...
        if (User::where('email', $email)->whereHas('teams', function ($q) use ($team) {
